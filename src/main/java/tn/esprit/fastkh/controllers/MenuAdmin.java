package tn.esprit.fast_hk.fast_hk.controllers;
...
public class MenuAdmin {
    ...
    @FXML
    void displayListUsers(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("../usersList.fxml"));
            Stage stage = (Stage) listUsers.getScene().getWindow(); // Assuming userWelcome is a node in your current scene
    ...
    @FXML
    void displayListDemandeChef(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("../listDemandsChefs.fxml"));
            Stage stage = (Stage) chefDemande.getScene().getWindow(); // Assuming userWelcome is a node in your current scene
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.show();
        } catch (IOException e) {
